...
// Highlight PROBLEM OF THE WEEK nav link when on potw.html
if (currentPage === "potw.html") {
  const potwLink = document.querySelector('.nav-links a[href="potw.html"]');
  if (potwLink) potwLink.classList.add("active");
}

// Highlight SPONSORS nav link when on sponsors.html
if (currentPage === "sponsors.html") {
  const sponsorsLink = document.querySelector('.nav-links a[href="sponsors.html"]');
